...
class Besok{
    ...
    */
    function average($atribut, $awal, $akhir){
        $data = $this->koneksi->query("SELECT waktu_jam, $atribut FROM tbl_dataperjam WHERE waktu_jam BETWEEN '04:00:00' AND '24:00:00' AND DATE(waktu_tanggal) = CURDATE() LIMIT $awal, $akhir");
        $hasil = 0;
        $avg = 0;
        $jumlah = 0;
        ...
        */
        ...
        // if($jumlah < 1) {
        //     $cek = $this->koneksi->query("SELECT count(id_dataperjam) AS jumlah FROM tbl_dataperjam WHERE waktu_jam BETWEEN '04:00:00' AND '24:00:00' AND DATE(waktu_tanggal) = CURDATE()");
